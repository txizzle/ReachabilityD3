...
%
%
% %%-------------Jaime F. Fisac comments, Mar 22, 2015----------------%%
% %%                                                                  %%
% %%--This function in fact yields a slice cutting at coordinates xs--%%
...
if nargin<3, N2D = g.N(~dims); end
if isempty(N2D), N2D = g.N(~dims); end
