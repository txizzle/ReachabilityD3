...
$.get("../data_contours21/twoislands.txt", function(data) {
  islands = data.split("\n");
});
...
d3.csv("../data_contours21/t1d1z2Data.csv", function(mydata) {
  svg.append("path").datum(mydata).attr("class", "line").attr("d", line);
});

function updateContour() {
  var currFile = "../data_contours21/t" + currTime + "d" + currDefender + "z" + currEvader + "Data";
